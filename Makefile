...
INCPATH = /home/knippsch/ExternLibraries/hdf5-1.8.17/include

# additional libraries

LIBS = hdf5_cpp hdf5 sz z dl m

LIBPATH = /home/knippsch/ExternLibraries/hdf5-1.8.17/lib /usr/local/lib 

# scheduling and optimization options
CFLAGS = -Wall -pedantic -std=c++11 -march=native -O2 \
...
$(MAIN): %: %.o $(addsuffix .o,$(MODULES)) Makefile
	$(CLINKER) $< $(addsuffix .o,$(MODULES)) $(CFLAGS) $(LOGOPTION) \
	   $(addprefix -L,$(LIBPATH)) $(addprefix -l,$(LIBS)) -lm -o $@
